class Config(object):
    ...
    train_file = '/search/odin/zhuyun/Data/google-text-normalization-data/TNFine-Data/Train90-Fine'
    dev_file = '/search/odin/zhuyun/Data/google-text-normalization-data/TNFine-Data/Dev5-Fine'
    test_file = '/search/odin/zhuyun/Data/google-text-normalization-data/TNFine-Data/Test5-Fine'
